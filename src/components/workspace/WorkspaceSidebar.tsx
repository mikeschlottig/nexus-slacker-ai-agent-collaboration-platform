    ...
    <div className="flex flex-col h-full select-none bg-[#3F0E40]">
      ...
      <ScrollArea className="flex-1">
        <div className="p-2 space-y-6">
          ...
          <section>
            ...
            <div className="mt-1 space-y-[1px]">
              <div className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-slate-300 hover:bg-white/5 hover:text-white cursor-pointer transition-colors group">
                ...
                <Bot className="w-3.5 h-3.5 opacity-40 ml-auto group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
          </section>
        </div>
      ...
      <div className="p-3 border-t border-white/10 bg-[#350d36] shrink-0">
        <div className="flex items-center justify-between group">
          ...
          <button className="opacity-40 hover:opacity-100 p-1.5 hover:bg-white/10 rounded transition-opacity shrink-0">
